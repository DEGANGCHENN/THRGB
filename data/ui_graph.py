...
class Interaction(Data,Graph):
    def __init__(self, conf, training, valid_set, test):
        Graph.__init__(self)
        Data.__init__(self,conf,training, valid_set, test)
        ...
        self.norm_interact = self.normalize_graph_mat(self.interaction_mat)
        # popularity_user = {}
        # for u in self.user:
